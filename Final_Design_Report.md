...
`[Insert Link to Full Online User Manual Here]`
...
* **Spring Final PPT Presentation:** `[Insert Link Here]`
* **Fall SD1 Presentation:** `[Insert Link Here]`

---

## 6. Final Expo Poster

* **Final Expo Poster PDF:** `[Insert Link Here]`
...
**Project Total Hours:** `[Insert Total Hours]`

### Christian Graber (API Designer & Software Lead)
* **Fall Hours:** `[Insert Hours]` | **Spring Hours:** `[Insert Hours]` | **Total:** `[Insert Hours]`
* **Justification:** Focused on designing the core software architecture. Built the board server and remote server, co-developed and tested OCR and object detection models, and defined production-level APIs for the hardware interface, vision models, and database.

### Mohamed Elmogaber
* **Fall Hours:** `[Insert Hours]` | **Spring Hours:** `[Insert Hours]` | **Total:** `[Insert Hours]`
* **Justification:** Worked extensively on building out the object detection functionality. Single-handedly designed and 3D-printed the physical glasses hardware, bridging the software with the physical world.

### Jared Walden
* **Fall Hours:** `[Insert Hours]` | **Spring Hours:** `[Insert Hours]` | **Total:** `[Insert Hours]`
* **Justification:** Focused efforts on developing the Swift native application for iOS, managing network discovery, latency monitoring, and integrating the text-to-speech feedback loop.

### Viet Ton
* **Fall Hours:** `[Insert Hours]` | **Spring Hours:** `[Insert Hours]` | **Total:** `[Insert Hours]`
* **Justification:** Spearheaded the Retrieval-Augmented Generation (RAG) pipeline integration, enabling the system to provide contextually aware auditory descriptions.
...
| Item | Cost | Notes |
|------|------|-------|
| Radxa Zero 3W Boards & Cameras | `[$XX.XX]` | Generously funded by Mohamed Elmogaber. |
| 3D Printing Materials | `[$XX.XX]` | Funded by Mohamed Elmogaber. |
| **Total** | `[$XX.XX]` | |
...
* **Code Repositories:** * NorthStar Server: `[Insert GitHub Link]`
  * NorthStar iOS App: `[Insert GitHub Link]`
* **Meeting Notes:** `[Insert Link to Notion/Drive folder]`
* **Hardware CAD Files:** `[Insert Link]`
